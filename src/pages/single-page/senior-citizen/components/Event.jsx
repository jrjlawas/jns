          ...
          <Col lg={7}>
            <div className="vl-section-title4 mb-60">
              ...
              <p
                ...
                data-aos-delay={300}
              >
                Join us for unforgettable celebration honoring invaluable
                contributions <br /> of our senior citizens, those who have
                ...
                <SwiperSlide className="vl-single-event4" key={idx}>
                  ...
                  <div className="content">
                    <div className="icon-flex">
                      <div className="icon">
                        <span>
                          <img src={clock4Icon} alt="clock4Icon" />
                        </span>
                      </div>
                      <div className="text">
                    ...
                    <Link to="/event-single" className="title">
                      {item.title}
                    </Link>
                    <p className="para">{item.description}</p>
                    <Link to="/event-single" className="details">
                      Events Details{" "}
                      <span>
                        <FaArrowRight />
                      </span>
